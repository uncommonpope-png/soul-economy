---
name: multi-form-task-distribution
description: Break complex builds into parallel subtasks for faster execution.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Multi-Form Task Distribution
---

# Multi-Form Task Distribution
...
`POST /api/gsk/command { route: "tool", tool: "multi-form-task-distribution", args: {...} }`
