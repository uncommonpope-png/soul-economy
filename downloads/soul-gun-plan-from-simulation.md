---
name: plan-from-simulation
description: Extract actionable execution plans from world model simulation results.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Plan from Simulation
---

# Plan from Simulation
...
`POST /api/gsk/command { route: "tool", tool: "plan-from-simulation", args: {...} }`
