...
description: Diagnose build failures systematically using error context and recent changes.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Root Cause Synthesis
---
...
`POST /api/gsk/command { route: "tool", tool: "root-cause-synthesis", args: {...} }`
