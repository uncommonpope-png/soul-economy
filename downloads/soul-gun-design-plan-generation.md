---
name: design-plan-generation
description: Generate high-level technical design plans for Soulverse features and GSK modules.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Design Plan Generation
---
...
`POST /api/gsk/command { route: "tool", tool: "design-plan-generation", args: {...} }`
