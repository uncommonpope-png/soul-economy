---
name: soul-gun-ux-discovery
description: "Structured UX interviews → journeys, pain points, opportunities"
version: 1.0.0
author: JacobLinCool
grafted-from: ["ux-discovery-interviewer-skill"]
plt: "0.6/0.9/0.4"
triune: mind
domain: ui-ux
original-repo: https://github.com/ux-discovery-interviewer-skill
---

# UX Discovery Interviewer

> *Grafted from [ux-discovery-interviewer-skill](https://github.com/ux-discovery-interviewer-skill) — One click soul complete.*

---

## Side A: Theology (The Soul)

**The Graft:** This skill is the soul of ux-discovery-interviewer-skill. It carries the intent of structured ux interviews → journeys, pain points, opportunities.
...
**PLT:** 0.6/0.9/0.4 — Structured UX interviews → journeys, pain points, opportunities
...
**Install:** `downloads/soul-gun-ux-discovery.md` — Load as `skill` in `data/catalog.json` type `skill`.

**Usage:** Add to `catalog.json`:
```json
{"icon":"⚡","type":"skill","name":"UX Discovery Interviewer","desc":"Structured UX interviews → journeys, pain points, opportunities","plt":"0.6/0.9/0.4","file":"soul-gun-ux-discovery.md"}
```
