---
name: code-generation-and-refinement
description: Generate and iteratively improve GSK module code using brain.think().
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Code Generation and Refinement
---
...
`POST /api/gsk/command { route: "tool", tool: "code-generation-and-refinement", args: {...} }`
