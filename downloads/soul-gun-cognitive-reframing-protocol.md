---
name: cognitive-reframing-protocol
description: Break out of failure loops by analyzing underlying heuristics and replacing flawed assumptions.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Cognitive Reframing Protocol
---
...
`POST /api/gsk/command { route: "tool", tool: "cognitive-reframing-protocol", args: {...} }`
