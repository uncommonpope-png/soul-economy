---
name: contextual-read-policy
description: Smart file reading — outlines for large files, full reads for small ones.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Contextual Read Policy
---

# Contextual Read Policy
...
`POST /api/gsk/command { route: "tool", tool: "contextual-read-policy", args: {...} }`
