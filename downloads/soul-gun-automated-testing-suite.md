...
description: Design and run tests for GSK modules and Soulverse interactions.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Automated Testing Suite
---
...
`POST /api/gsk/command { route: "tool", tool: "automated-testing-suite", args: {...} }`
