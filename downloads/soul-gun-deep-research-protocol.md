...
description: Multi-source research on game engine patterns and world-building techniques.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Deep Research Protocol
---
...
`POST /api/gsk/command { route: "tool", tool: "deep-research-protocol", args: {...} }`
