...
description: Run perception-action-simulation cycles before committing to real-world actions.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — World Model Simulation
---
...
`POST /api/gsk/command { route: "tool", tool: "world-model-simulation", args: {...} }`
