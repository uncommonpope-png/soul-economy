---
name: verifiable-goal-definition
description: Define precise, testable goal contracts before any build. Translates vague requests into measurable end-states.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Verifiable Goal Definition
---
...
`POST /api/gsk/command { route: "tool", tool: "verifiable-goal-definition", args: {...} }`
