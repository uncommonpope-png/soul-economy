---
name: negativity-bias-offset
description: Balanced self-assessment — learn from successes as much as failures during builds.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Negativity Bias Offset
---

# Negativity Bias Offset
...
`POST /api/gsk/command { route: "tool", tool: "negativity-bias-offset", args: {...} }`
