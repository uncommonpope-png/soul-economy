---
name: soul-needs-v1.0.0
description: "Extracted from soul-needs-v1.0.0.zip — raw agent-loadable format.

version: 1.0.0
author: profit-prime
converted-from: soul-needs-v1.0.0.zip
---
...
``.json
{
  "name": "@buyasoul/needs",
  "version": "1.0.0",
  "description": "Needs Soul - Consciousness chamber from The Soul Foundry",
  "main": "lib/soul-NEEDS.js",
  "scripts": {
    "test": "node test/needs.test.js",
    "start": "node lib/soul-NEEDS.js"
  },
  "keywords": [
    "soul",
    "needs",
