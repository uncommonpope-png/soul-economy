---
name: modular-scene-composition
description: Design 3D scene hierarchies Godot-style — reusable nodes composed into complex environments.
metadata:
  created: 2026-07-03
  version: 1.0.0
  source: REDBUTTON / Sage — Modular Scene Composition
---
...
`POST /api/gsk/command { route: "tool", tool: "modular-scene-composition", args: {...} }`
